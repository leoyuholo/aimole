...
module.exports = [
	...
	'https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.3/mode-javascript.js'
	'https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.3/mode-python.js'
	'https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.3/mode-ruby.js'
	...
	'https://www.parsecdn.com/js/parse-latest.min.js'
